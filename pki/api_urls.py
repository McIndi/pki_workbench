...
from .api_views import (
    ...
    DashboardAPIView,
    DeleteCAWorkflowAPIView,
    DeleteCertificateWorkflowAPIView,
    DeleteCSRWorkflowAPIView,
    DeletePrivateKeyWorkflowAPIView,
...
urlpatterns = [
    ...
    path('workflows/delete-certificate/', DeleteCertificateWorkflowAPIView.as_view(), name='api-workflow-delete-certificate'),
    path('workflows/delete-ca/', DeleteCAWorkflowAPIView.as_view(), name='api-workflow-delete-ca'),
    path('workflows/delete-private-key/', DeletePrivateKeyWorkflowAPIView.as_view(), name='api-workflow-delete-private-key'),
    path('workflows/delete-csr/', DeleteCSRWorkflowAPIView.as_view(), name='api-workflow-delete-csr'),
    path(
